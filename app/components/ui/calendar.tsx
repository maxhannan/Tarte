    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 dark:text-neutral-200 text-neutral-700"
        ),
        ...
        day: cn(
          ...
          "h-11 w-11 p-0 font-normal aria-selected:opacity-100 dark:text-neutral-200 text-neutral-800 text-lg "
        ),
        day_selected:
