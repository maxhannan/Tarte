...
const RecipeSummary = ({ id, name, category, user }: recipeSummaryProps) => {
  ...
  return (
    ...
    >
      <div className="inline-flex flex-shrink-0 items-center mr-4 justify-center w-12 h-12 overflow-hidden bg-neutral-500 text-neutral-700 border-neutral-300 rounded-r-2xl rounded-l-md rounded-bl-2xl dark:bg-neutral-800 border dark:border-neutral-700">
