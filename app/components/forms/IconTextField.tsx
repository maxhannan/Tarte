    ...
    <div className="grow">
      ...
      <div className="relative">
        ...
        <input
          id={identifier}
          name={identifier}
          className="block h-12 w-full p-2 pl-10 text-base text-neutral-900  border-neutral-300 border rounded-md bg-neutral-100 focus:ring-2 focus:border-neutral-50 focus:outline-none  focus:ring-neutral-400  dark:bg-neutral-800 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-neutral-50 dark:focus:ring-blue-500 dark:focus:border-blue-500"
