...
const IngredientTable = ({ ingredients }: { ingredients: Ingredient[] }) => {
  return (
    <div className=" border border-neutral-300 dark:border-neutral-700 rounded-tl-md  rounded-3xl font-light   text-lg text-neutral-700 dark:text-neutral-100 ">
      <table className="w-full max-w-4xl mx-auto overflow-hidden table-fixed rounded-tl-md  rounded-3xl ">
