...
const PrepListItem = ({ name, unit }: Props) => {
  return (
    <div className="  max-w-full  bg-neutral-100 border-neutral-300 border bg-opacity-50 dark:bg-opacity-50   rounded-xl  py-2 px-2 grid grid-cols-12 gap-1   dark:bg-neutral-800 dark:border-neutral-700">
      <div className=" font-light col-span-6 flex gap-2 items-center mr-2">
        <div>
