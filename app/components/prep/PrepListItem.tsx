...
const PrepListItem = ({ name, unit }: Props) => {
  return (
    <div className="  w-full  bg-neutral-100 border-neutral-300 border bg-opacity-50 dark:bg-opacity-50   rounded-xl  py-4  grid grid-cols-12 justify-start items-center  px-4 hover:bg-neutral-300 dark:hover:bg-neutral-700 dark:bg-neutral-800 dark:border-neutral-700">
