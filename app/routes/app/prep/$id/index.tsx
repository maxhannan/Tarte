      ...
      >
        ...
        <div className="fixed inset-0 flex items-center justify-center">
          <Dialog.Panel className="w-full max-w-md bg-neutral-100 dark:bg-transparent  rounded-xl p-4">
            <div className=" container mx-auto carousel rounded-box  border border-neutral-200 dark:border-neutral-700 aspect-[8/10] ">
              ...
              <div id="item3" className="carousel-item w-full ">
                <img
                  ...
                  className="min-w-full  min-h-full object-contain aspect-[8/10]"
                  alt="Tailwind CSS Carousel component"
                />
              </div>
